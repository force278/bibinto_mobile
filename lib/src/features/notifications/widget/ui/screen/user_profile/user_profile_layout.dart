...
import 'package:bibinto/src/features/notifications/widget/ui/screen/user_profile/widgets/info_and_button.dart';
import 'package:bibinto/src/features/notifications/widget/ui/screen/user_profile/widgets/profile_photo_and_name.dart';
...
class UserProfileInNotificationsLayout extends StatelessWidget {
  const UserProfileInNotificationsLayout({super.key});
            ...
            return GestureDetector(
              onTap: () {
                AutoRouter.of(context).push(
                  OpenPostRouteInNotifications(user: user, initialIndex: index),
                );
              },
              child: Image.network(
