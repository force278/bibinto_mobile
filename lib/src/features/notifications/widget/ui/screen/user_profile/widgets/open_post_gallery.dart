...
import 'package:bibinto/src/features/notifications/widget/ui/screen/user_profile/widgets/enter_comment.dart';
...
@RoutePage()
class OpenPostPageInNotifications extends StatefulWidget {
  const OpenPostPageInNotifications({
    super.key,
    required this.user,
  ...
  @override
  State<OpenPostPageInNotifications> createState() => _OpenPostPageState();
}

class _OpenPostPageState extends State<OpenPostPageInNotifications> {
  ...
  void initState() {
    ...
    BlocProvider.of<NotificationsBloc>(context)
        .add(FetchUserProfileInNotifications(widget.user.username));
  }
                        ...
                        IconButton(
                          onPressed: () {
                            BlocProvider.of<NotificationsBloc>(context).add(
                              ToggleLikeInNotifications(post?.id ?? 0, 10),
                            );
                          },
